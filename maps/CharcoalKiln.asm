...
CharcoalKiln_MapEvents:
	...
	object_event  5,  6, SPRITE_SULFURA, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CharcoalKilnCanarticho, EVENT_CHARCOAL_KILN_CANARTICHO
