...
.ka_ga:    db CANINOS, MACHAMP, DRACOLOSSE, PINSIR, SNORLAX, KABUTO, KABUTOPS, KAPOERA, CARABAFFE, BLASTOISE, CANARTICHO, CUBONE, MAROWAK, KANGOUREX, -1
.ki_gi:    db HELIATRONC, CHENIPAN, GYARADOS, GALOPA, FEUNARD, GIRAFARIG, JOLIFLOR, HYPOROI, KRABBOSS, -1
...
.ne:       db NATU, XATU, -1
.no:       db INSOLOURDO, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRACO, BUTTERFREE, CIZAYOX, GRANIVOL, LEUPHORIE, PARAS, PARASECT, QWILFISH, MR__MIME, DEBUGANT, CRUSTABRI, TYRANITAR, -1
...
.ra:       db RAIKOU, RAICHU, LEVEINARD, RATICATE, LAPRAS, VILEPLUME, LANTURN, -1
