...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORETRESS, GRODOUDOU, HERBIZARRE, BULBIZARRE, FLORIZARRE, PTERA, MAGBY, IGGLYBUFF, NOCTALI, ARTIKODIN, JIGGLYPUFF, SNUBBULL, -1
