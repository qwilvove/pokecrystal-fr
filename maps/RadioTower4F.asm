...
RadioTowerMiaouss:
	opentext
	writetext RadioTowerMiaoussText
	cry MIAOUSS
	waitbutton
	closetext
	end
...
RadioTower4F_MapEvents:
	...
	object_event 12,  7, SPRITE_CANINOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RadioTowerMiaouss, -1
