...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBIZARRE, FLORIZARRE, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTIKODIN, JIGGLYPUFF, SNUBBULL, -1
