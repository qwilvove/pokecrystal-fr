...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite BigRonflexSpriteGFX, 12, STANDING_SPRITE, PAL_OW_BLUE
	...
	overworld_sprite RamolossSpriteGFX, 4, STILL_SPRITE, PAL_OW_RED
	overworld_sprite CaptainSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
	overworld_sprite BigLokhlassSpriteGFX, 12, STANDING_SPRITE, PAL_OW_BLUE
	...
	overworld_sprite SimularbreSpriteGFX, 12, STANDING_SPRITE, PAL_OW_GREEN
