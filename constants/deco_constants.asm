...
; DecorationIDs indexes (see data/decorations/decorations.asm)
	...
	const DECOFLAG_MELOFEE_POSTER
	const DECOFLAG_RONDOUDOU_POSTER
	...
	const DECOFLAG_MELOFEE_DOLL
	const DECOFLAG_RONDOUDOU_DOLL
	const DECOFLAG_BULBIZARRE_DOLL
	const DECOFLAG_SALAMECHE_DOLL
	const DECOFLAG_CARAPUCE_DOLL
	const DECOFLAG_PTITARD_DOLL
	const DECOFLAG_TAUPIQUEUR_DOLL
	const DECOFLAG_STARI_DOLL
	const DECOFLAG_MAGICARPE_DOLL
	const DECOFLAG_MYSTHERBE_DOLL
	const DECOFLAG_ECTOPLASMA_DOLL
	const DECOFLAG_KOKIYAS_DOLL
	const DECOFLAG_TADMORV_DOLL
	const DECOFLAG_VOLTORBE_DOLL
	const DECOFLAG_ASPICOT_DOLL
	const DECOFLAG_ZARBI_DOLL
...
; FindOwnedPosters.posters values (see engine/overworld/decorations.asm)
	...
	const DECO_MELOFEE_POSTER
	const DECO_RONDOUDOU_POSTER
...
; FindOwnedOrnaments.ornaments values (see engine/overworld/decorations.asm)
	...
	const DECO_MELOFEE_DOLL
	const DECO_RONDOUDOU_DOLL
	const DECO_BULBIZARRE_DOLL
	const DECO_SALAMECHE_DOLL
	const DECO_CARAPUCE_DOLL
	const DECO_PTITARD_DOLL
	const DECO_TAUPIQUEUR_DOLL
	const DECO_STARI_DOLL
	const DECO_MAGICARPE_DOLL
	const DECO_MYSTHERBE_DOLL
	const DECO_ECTOPLASMA_DOLL
	const DECO_KOKIYAS_DOLL
	const DECO_TADMORV_DOLL
	const DECO_VOLTORBE_DOLL
	const DECO_ASPICOT_DOLL
	const DECO_ZARBI_DOLL
	const DECO_RACAILLOU_DOLL
	const DECO_MACHOC_DOLL
