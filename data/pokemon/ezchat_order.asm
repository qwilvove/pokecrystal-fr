...
.o:        db ALIGATUEUR, FOUINAR, OCTILLERY, COLOSSINGE, SENTRET, CERFROUSSE, SPEAROW, FEAROW, AMONISTAR, AMONITA, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORETRESS, WIGGLYTUFF, IVYSAUR, BULBIZARRE, FLORIZARRE, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTIKODIN, JIGGLYPUFF, SNUBBULL, -1
