...
### Ramoloss Well's stones use the wrong corner tile

This is a mistake with block $5B in the `johto_modern` tileset. The bottom-left corners of the three stones around Ramoloss Well use tile $4B, but should use tile $47.

![image](https://raw.githubusercontent.com/pret/pokecrystal/master/docs/images/ramoloss_well.png)
