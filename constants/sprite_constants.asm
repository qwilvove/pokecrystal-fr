...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_CAL ; 44
	const SPRITE_RAMOLOSS ; 45
	const SPRITE_CAPTAIN ; 46
	const SPRITE_BIG_LOKHLASS ; 47
...
DEF SPRITE_POKEMON EQU const_value
	...
	const SPRITE_KOKIYAS ; 84
	const SPRITE_MYSTHERBE ; 85
	const SPRITE_ECTOPLASMA ; 86
	const SPRITE_NOSFERAPTI ; 87
	const SPRITE_MAGICARPE ; 88
	const SPRITE_CARAPUCE ; 89
	const SPRITE_TOGEPI ; 8a
	const SPRITE_PAPILUSION ; 8b
	const SPRITE_TAUPIQUEUR ; 8c
	const SPRITE_PTITARD ; 8d
	const SPRITE_PIKACHU ; 8e
	const SPRITE_MELOFEE ; 8f
	const SPRITE_SALAMECHE ; 90
	const SPRITE_LIPPOUTOU ; 91
	const SPRITE_STAROSS ; 92
	const SPRITE_BULBIZARRE ; 93
	const SPRITE_RONDOUDOU ; 94
	const SPRITE_TADMORV ; 95
	const SPRITE_ABO ; 96
	const SPRITE_PARAS ; 97
	const SPRITE_TENTACOOL ; 98
	const SPRITE_TAUROS ; 99
	const SPRITE_MACHOC ; 9a
	const SPRITE_VOLTORBE ; 9b
	const SPRITE_LOKHLASS ; 9c
	const SPRITE_RHINOFEROS ; 9d
	const SPRITE_SULFURA ; 9e
	const SPRITE_RONFLEX ; 9f
	const SPRITE_LEVIATOR ; a0
