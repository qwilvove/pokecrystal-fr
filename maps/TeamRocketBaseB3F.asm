	...
	const TEAMROCKETBASEB3F_SULFURA
...
LanceGetPasswordScript:
	...
	pause 5
	turnobject TEAMROCKETBASEB3F_SULFURA, RIGHT
	pause 20
...
RocketBaseCornebre:
	opentext
	writetext RocketBaseCornebreText
	waitbutton
	closetext
...
GruntF5Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_RAMOLOSSTAIL
	end
...
GruntM28Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_RATTATAC_TAIL
	end
...
.Script:
	opentext
	checkevent EVENT_LEARNED_RAMOLOSSTAIL
	iffalse .NeedsPassword
	checkevent EVENT_LEARNED_RATTATAC_TAIL
	iffalse .NeedsPassword
	sjump .OpenSesame
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  7,  2, SPRITE_SULFURA, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, RocketBaseCornebre, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event 21,  7, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, RamolossTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event  5, 14, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, RattatacTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
