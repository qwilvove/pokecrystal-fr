...
.Frames:
	...
	dw CreditsToudoudouGFX
	dw CreditsToudoudouGFX + 16 tiles
	dw CreditsToudoudouGFX + 32 tiles
	dw CreditsToudoudouGFX + 48 tiles
...
CreditsToudoudouGFX: INCBIN "gfx/credits/toudoudou.2bpp"
