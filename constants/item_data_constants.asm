...
; held item effects
	...
	const HELD_COMBAT_BOOST
	const HELD_VOL_BOOST
	const HELD_POISON_BOOST
	const HELD_SOL_BOOST
	const HELD_ROCHE_BOOST
	const HELD_INSECTE_BOOST
	const HELD_SPECTRE_BOOST
	const HELD_FEU_BOOST
	const HELD_EAU_BOOST
	const HELD_PLANTE_BOOST
	const HELD_ELECTRIK_BOOST
