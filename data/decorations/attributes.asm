...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  RONDOUDOU,      SET_UP_POSTER,     EVENT_DECO_POSTER_4,                $25
	...
	decoration DECO_BIGDOLL, RONFLEX,         SET_UP_BIG_DOLL,   EVENT_DECO_BIG_RONFLEX_DOLL,        SPRITE_BIG_RONFLEX
	...
	decoration DECO_DOLL,    RONDOUDOU,      SET_UP_DOLL,       EVENT_DECO_RONDOUDOU_DOLL,         SPRITE_RONDOUDOU
	decoration DECO_DOLL,    BULBIZARRE,       SET_UP_DOLL,       EVENT_DECO_BULBIZARRE_DOLL,          SPRITE_BULBIZARRE
	decoration DECO_DOLL,    SALAMECHE,      SET_UP_DOLL,       EVENT_DECO_SALAMECHE_DOLL,         SPRITE_SALAMECHE
	...
	decoration DECO_DOLL,    TAUPIQUEUR,         SET_UP_DOLL,       EVENT_DECO_TAUPIQUEUR_DOLL,            SPRITE_TAUPIQUEUR
	decoration DECO_DOLL,    STARI,          SET_UP_DOLL,       EVENT_DECO_STARI_DOLL,             SPRITE_STAROSS
	...
	decoration DECO_DOLL,    ZARBI,           SET_UP_DOLL,       EVENT_DECO_ZARBI_DOLL,              SPRITE_ZARBI
