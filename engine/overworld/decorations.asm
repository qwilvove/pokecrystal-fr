...
.posters:
	...
	db DECO_MELOFEE_POSTER ; 12
	db DECO_RONDOUDOU_POSTER ; 13
	db -1
...
.ornaments:
	...
	db DECO_MELOFEE_DOLL ; 20
	db DECO_RONDOUDOU_DOLL ; 21
	db DECO_BULBIZARRE_DOLL ; 22
	db DECO_SALAMECHE_DOLL ; 23
	db DECO_CARAPUCE_DOLL ; 24
	db DECO_PTITARD_DOLL ; 25
	db DECO_TAUPIQUEUR_DOLL ; 26
	db DECO_STARI_DOLL ; 27
	db DECO_MAGICARPE_DOLL ; 28
	db DECO_MYSTHERBE_DOLL ; 29
	db DECO_ECTOPLASMA_DOLL ; 2a
	db DECO_KOKIYAS_DOLL ; 2b
	db DECO_TADMORV_DOLL ; 2c
	db DECO_VOLTORBE_DOLL ; 2d
	db DECO_ASPICOT_DOLL ; 2e
	db DECO_ZARBI_DOLL ; 2f
	db DECO_RACAILLOU_DOLL ; 30
	db DECO_MACHOC_DOLL ; 31
...
DecorationDesc_PosterPointers:
	...
	dbw DECO_MELOFEE_POSTER, DecorationDesc_MelofeePoster
	dbw DECO_RONDOUDOU_POSTER, DecorationDesc_RondoudouPoster
	db -1
...
DecorationDesc_MelofeePoster:
	jumptext .LookMelofeePosterText

.LookMelofeePosterText:
	text_far _LookMelofeePosterText
	text_end

DecorationDesc_RondoudouPoster:
	jumptext .LookRondoudouPosterText

.LookRondoudouPosterText:
	text_far _LookRondoudouPosterText
	text_end
