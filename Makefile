...
pokecrystal_opt       = -Cjv -t PM_CRYSTAL -i BYTF -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal_debug_opt = -Cjv -t PM_CRYSTAL -i BYTF -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal_vc_opt    = -Cjv -t PM_CRYSTAL -i BYTF -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
