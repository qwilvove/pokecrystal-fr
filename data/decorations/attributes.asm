...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  MELOFEE,        SET_UP_POSTER,     EVENT_DECO_POSTER_3,                $24
	...
	decoration DECO_BIGDOLL, LOKHLASS,          SET_UP_BIG_DOLL,   EVENT_DECO_BIG_LOKHLASS_DOLL,         SPRITE_BIG_LOKHLASS
	...
	decoration DECO_DOLL,    MELOFEE,        SET_UP_DOLL,       EVENT_DECO_MELOFEE_DOLL,           SPRITE_MELOFEE
	decoration DECO_DOLL,    JIGGLYPUFF,      SET_UP_DOLL,       EVENT_DECO_JIGGLYPUFF_DOLL,         SPRITE_JIGGLYPUFF
	decoration DECO_DOLL,    BULBIZARRE,       SET_UP_DOLL,       EVENT_DECO_BULBIZARRE_DOLL,          SPRITE_BULBIZARRE
