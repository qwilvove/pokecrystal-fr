...
; SGBLayoutJumptable indexes (see engine/gfx/sgb_layouts.asm)
	...
	const SCGB_POKEDEX_ZARBI_MODE
	const SCGB_BILLS_PC
	const SCGB_ZARBI_PUZZLE
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_GS_INTRO_KOKIYAS_LOKHLASS
	const PREDEFPAL_BETA_INTRO_LOKHLASS
	const PREDEFPAL_GS_INTRO_RONDOUDOU_PIKACHU_BG
	const PREDEFPAL_GS_INTRO_RONDOUDOU_PIKACHU_OB
	const PREDEFPAL_GS_INTRO_STARTERS_TRANSITION
	const PREDEFPAL_BETA_INTRO_FLORIZARRE
	const PREDEFPAL_PACK ; GS_INTRO_DRACAUFEU
