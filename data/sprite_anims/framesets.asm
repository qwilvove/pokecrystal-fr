...
.Frameset_SlotsGrolem:
	oamframe SPRITE_ANIM_OAMSET_SLOTS_GROLEM_1,  7
	oamframe SPRITE_ANIM_OAMSET_SLOTS_GROLEM_2,  7
	oamframe SPRITE_ANIM_OAMSET_SLOTS_GROLEM_1,  7, B_OAM_YFLIP
	oamframe SPRITE_ANIM_OAMSET_SLOTS_GROLEM_2,  7, B_OAM_XFLIP
	oamrestart
