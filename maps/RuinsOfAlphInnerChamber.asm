...
RuinsOfAlphInnerChamberStrangePresenceScript:
	...
	setevent EVENT_MADE_ZARBI_APPEAR_IN_RUINS
...
RuinsOfAlphInnerChamber_MapEvents:
	...
	warp_event  3, 21, RUINS_OF_ALPH_AMONITA_CHAMBER, 3
	warp_event  4, 21, RUINS_OF_ALPH_AMONITA_CHAMBER, 4
	warp_event 15, 24, RUINS_OF_ALPH_PTERA_CHAMBER, 3
	warp_event 16, 24, RUINS_OF_ALPH_PTERA_CHAMBER, 4
