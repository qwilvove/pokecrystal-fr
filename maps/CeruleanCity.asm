...
CeruleanCityFlagadoss:
	opentext
	writetext CeruleanCityFlagadossText
	cry FLAGADOSS
	waitbutton
	closetext
	end
...
CeruleanCity_MapEvents:
	...
	object_event 20, 24, SPRITE_RAMOLOSS, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanCityFlagadoss, -1
