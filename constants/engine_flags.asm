...
; wUnlockedZarbis
	const ENGINE_UNLOCKED_ZARBIS_A_TO_K
	const ENGINE_UNLOCKED_ZARBIS_L_TO_R
	const ENGINE_UNLOCKED_ZARBIS_S_TO_W
	const ENGINE_UNLOCKED_ZARBIS_X_TO_Z
	const ENGINE_UNLOCKED_ZARBIS_UNUSED_4
	const ENGINE_UNLOCKED_ZARBIS_UNUSED_5
	const ENGINE_UNLOCKED_ZARBIS_UNUSED_6
	const ENGINE_UNLOCKED_ZARBIS_UNUSED_7
; wVisitedSpawns
...
; wDailyFlags2
	const ENGINE_MT_MOON_SQUARE_MELOFEE
	const ENGINE_UNION_CAVE_LOKHLASS
