...
INCBIN "gfx/footprints/roucool.1bpp",     footprint_bottom
; 017-024 top halves
...
INCBIN "gfx/footprints/rapasdepic.1bpp",     footprint_top
...
INCBIN "gfx/footprints/rapasdepic.1bpp",     footprint_bottom
...
INCBIN "gfx/footprints/rondoudou.1bpp", footprint_top
...
INCBIN "gfx/footprints/rondoudou.1bpp", footprint_bottom
INCBIN "gfx/footprints/grodoudou.1bpp", footprint_bottom
; 041-048 top halves
INCBIN "gfx/footprints/nosferapti.1bpp",      footprint_top
...
INCBIN "gfx/footprints/nosferapti.1bpp",      footprint_bottom
...
INCBIN "gfx/footprints/triopikeur.1bpp",    footprint_top
...
INCBIN "gfx/footprints/triopikeur.1bpp",    footprint_bottom
...
INCBIN "gfx/footprints/tetarte.1bpp",  footprint_top
...
INCBIN "gfx/footprints/tetarte.1bpp",  footprint_bottom
...
INCBIN "gfx/footprints/racaillou.1bpp",    footprint_top
...
INCBIN "gfx/footprints/ramoloss.1bpp",   footprint_top
...
INCBIN "gfx/footprints/racaillou.1bpp",    footprint_bottom
...
INCBIN "gfx/footprints/ramoloss.1bpp",   footprint_bottom
...
INCBIN "gfx/footprints/scarabrute.1bpp",     footprint_bottom
...
INCBIN "gfx/footprints/voltali.1bpp",    footprint_top
...
INCBIN "gfx/footprints/voltali.1bpp",    footprint_bottom
...
INCBIN "gfx/footprints/ronflex.1bpp",    footprint_top
...
INCBIN "gfx/footprints/ronflex.1bpp",    footprint_bottom
...
INCBIN "gfx/footprints/noarfang.1bpp",    footprint_top
INCBIN "gfx/footprints/coxy.1bpp",     footprint_top
INCBIN "gfx/footprints/coxyclaque.1bpp",     footprint_top
INCBIN "gfx/footprints/mimigal.1bpp",   footprint_top
INCBIN "gfx/footprints/migalos.1bpp",    footprint_top
...
INCBIN "gfx/footprints/noarfang.1bpp",    footprint_bottom
...
INCBIN "gfx/footprints/wattouat.1bpp",     footprint_top
...
INCBIN "gfx/footprints/wattouat.1bpp",     footprint_bottom
...
; 185-192 top halves
INCBIN "gfx/footprints/simularbre.1bpp",  footprint_top
INCBIN "gfx/footprints/tarpaud.1bpp",   footprint_top
...
INCBIN "gfx/footprints/tarpaud.1bpp",   footprint_bottom
...
; 201-208 top halves
INCBIN "gfx/footprints/zarbi.1bpp",      footprint_top
INCBIN "gfx/footprints/qulbutoke.1bpp",  footprint_top
INCBIN "gfx/footprints/girafarig.1bpp",  footprint_top
INCBIN "gfx/footprints/pomdepik.1bpp",     footprint_top
INCBIN "gfx/footprints/foretress.1bpp", footprint_top
INCBIN "gfx/footprints/insolourdo.1bpp",  footprint_top
INCBIN "gfx/footprints/scorplane.1bpp",     footprint_top
INCBIN "gfx/footprints/steelix.1bpp",    footprint_top
; 201-208 bottom halves
INCBIN "gfx/footprints/zarbi.1bpp",      footprint_bottom
INCBIN "gfx/footprints/qulbutoke.1bpp",  footprint_bottom
INCBIN "gfx/footprints/girafarig.1bpp",  footprint_bottom
INCBIN "gfx/footprints/pomdepik.1bpp",     footprint_bottom
INCBIN "gfx/footprints/foretress.1bpp", footprint_bottom
INCBIN "gfx/footprints/insolourdo.1bpp",  footprint_bottom
INCBIN "gfx/footprints/scorplane.1bpp",     footprint_bottom
...
INCBIN "gfx/footprints/malosse.1bpp",   footprint_top
...
INCBIN "gfx/footprints/malosse.1bpp",   footprint_bottom
