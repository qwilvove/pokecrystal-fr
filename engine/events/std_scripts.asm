...
InitializeEventsScript:
	...
	setevent EVENT_MAHOGANY_MART_LANCE_AND_DRACOLOSSE
	setevent EVENT_TEAM_ROCKET_BASE_B2F_GRUNT_WITH_EXECUTIVE
	setevent EVENT_TEAM_ROCKET_BASE_B2F_EXECUTIVE
	setevent EVENT_TEAM_ROCKET_BASE_B2F_DRACOLOSSE
	...
	setevent EVENT_AZALEA_TOWN_RAMOLOSSS
	setevent EVENT_KURTS_HOUSE_RAMOLOSS
	...
	variablesprite SPRITE_WEIRD_TREE, SPRITE_SIMULARBRE
	...
	setevent EVENT_MT_MOON_SQUARE_MELOFEE
