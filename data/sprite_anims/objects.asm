...
; SPRITE_ANIM_OBJ_SLOTS_GROLEM
	db SPRITE_ANIM_FRAMESET_SLOTS_GROLEM,               SPRITE_ANIM_FUNC_SLOTS_GROLEM,               SPRITE_ANIM_DICT_SLOTS
; SPRITE_ANIM_OBJ_SLOTS_LEVEINARD
	db SPRITE_ANIM_FRAMESET_SLOTS_LEVEINARD,             SPRITE_ANIM_FUNC_SLOTS_LEVEINARD,             SPRITE_ANIM_DICT_SLOTS
...
; SPRITE_ANIM_OBJ_INTRO_PICHU
	db SPRITE_ANIM_FRAMESET_INTRO_PICHU,               SPRITE_ANIM_FUNC_INTRO_PICHU_AXOLOTO,        SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_OBJ_INTRO_AXOLOTO
	db SPRITE_ANIM_FRAMESET_INTRO_AXOLOTO,              SPRITE_ANIM_FUNC_INTRO_PICHU_AXOLOTO,        SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_OBJ_INTRO_ZARBI
	db SPRITE_ANIM_FRAMESET_INTRO_ZARBI_1,             SPRITE_ANIM_FUNC_INTRO_ZARBI,               SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_OBJ_INTRO_ZARBI_F
	db SPRITE_ANIM_FRAMESET_INTRO_ZARBI_F,             SPRITE_ANIM_FUNC_INTRO_ZARBI_F,             SPRITE_ANIM_DICT_DEFAULT
