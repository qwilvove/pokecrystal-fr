...
wRuinsOfAlphPteraChamberSceneID::            db
...
wBestMagicarpeLengthFeet:: db
wBestMagicarpeLengthInches:: db
wMagicarpeRecordHoldersName:: ds NAME_LENGTH
