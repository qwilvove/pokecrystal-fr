...
; Johto story events
	...
	const EVENT_GOT_HERICENDRE_FROM_ELM
	const EVENT_GOT_KAIMINUS_FROM_ELM
	const EVENT_GOT_GERMIGNON_FROM_ELM
	...
	const EVENT_HERDED_CANARTICHO
	const EVENT_FOUGHT_SIMULARBRE
	const EVENT_CLEARED_RAMOLOSS_WELL
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_ELMS_AIDE
	const EVENT_GOT_TOGEPI_EGG_FROM_ELMS_AIDE
	const EVENT_MADE_ZARBI_APPEAR_IN_RUINS
	...
	const EVENT_LAKE_OF_RAGE_EXPLAINED_WEIRD_MAGICARPE
	const EVENT_LAKE_OF_RAGE_ASKED_FOR_MAGICARPE
	...
	const EVENT_GOT_DEBUGANT_FROM_KIYO
	...
	const EVENT_GOT_KINGS_ROCK_IN_RAMOLOSS_WELL
...
; Kanto hidden items
	const EVENT_TAUPIQUEURS_CAVE_HIDDEN_MAX_REVIVE
...
; Ruins of Alph puzzles
	...
	const EVENT_SOLVED_AMONITA_PUZZLE
	const EVENT_SOLVED_PTERA_PUZZLE
; Decorations
	...
	const EVENT_DECO_MELOFEE_DOLL
	const EVENT_DECO_RONDOUDOU_DOLL
	const EVENT_DECO_BULBIZARRE_DOLL
	const EVENT_DECO_SALAMECHE_DOLL
	const EVENT_DECO_CARAPUCE_DOLL
	const EVENT_DECO_PTITARD_DOLL
	const EVENT_DECO_TAUPIQUEUR_DOLL
	const EVENT_DECO_STARI_DOLL
	const EVENT_DECO_MAGICARPE_DOLL
	const EVENT_DECO_MYSTHERBE_DOLL
	const EVENT_DECO_ECTOPLASMA_DOLL
	const EVENT_DECO_KOKIYAS_DOLL
	const EVENT_DECO_TADMORV_DOLL
	const EVENT_DECO_VOLTORBE_DOLL
	const EVENT_DECO_ASPICOT_DOLL
	const EVENT_DECO_ZARBI_DOLL
	const EVENT_DECO_RACAILLOU_DOLL
	const EVENT_DECO_MACHOC_DOLL
	const EVENT_DECO_TENTACOOL_DOLL
	const EVENT_PLAYERS_ROOM_POSTER
	const EVENT_DECO_GOLD_TROPHY
	const EVENT_DECO_SILVER_TROPHY
	const EVENT_DECO_BIG_RONFLEX_DOLL
	const EVENT_DECO_BIG_ONIX_DOLL
	const EVENT_DECO_BIG_LOKHLASS_DOLL
; More Johto story events
	...
	const EVENT_LEARNED_RAMOLOSSTAIL
	const EVENT_LEARNED_RATTATAC_TAIL
	...
	const EVENT_SHOWED_EXCELANGUE_TO_BILLS_GRANDPA
	const EVENT_SHOWED_MYSTHERBE_TO_BILLS_GRANDPA
	const EVENT_SHOWED_STARI_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CANINOS_GOUPIX_TO_BILLS_GRANDPA
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_WALL_OPENED_IN_AMONITA_CHAMBER
	const EVENT_WALL_OPENED_IN_PTERA_CHAMBER
...
; Johto itemballs
	const EVENT_HERICENDRE_POKEBALL_IN_ELMS_LAB
	const EVENT_KAIMINUS_POKEBALL_IN_ELMS_LAB
	const EVENT_GERMIGNON_POKEBALL_IN_ELMS_LAB
	...
	const EVENT_RAMOLOSS_WELL_B1F_SUPER_POTION
	const EVENT_RAMOLOSS_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	...
	const EVENT_MAHOGANY_MART_LANCE_AND_DRACOLOSSE
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_DRACOLOSSE
	...
	const EVENT_ILEX_FOREST_CANARTICHO
	...
	const EVENT_CHARCOAL_KILN_CANARTICHO
	const EVENT_CHARCOAL_KILN_APPRENTICE
	const EVENT_CHARCOAL_KILN_BOSS
	const EVENT_ROUTE_36_SIMULARBRE
	const EVENT_AZALEA_TOWN_RAMOLOSSS
	const EVENT_AZALEA_TOWN_RAMOLOSSTAIL_ROCKET
	const EVENT_RAMOLOSS_WELL_RAMOLOSSS
	const EVENT_RAMOLOSS_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_RAMOLOSS
	...
	const EVENT_RAMOLOSS_WELL_KURT
	...
	const EVENT_FOUGHT_RONFLEX
	const EVENT_LAKE_OF_RAGE_RED_LEVIATOR
	...
	const EVENT_UNION_CAVE_B2F_LOKHLASS
	...
	const EVENT_FLORIA_AT_SIMULARBRE
...
; Kanto people
	...
	const EVENT_VERMILION_CITY_RONFLEX
	...
	const EVENT_MT_MOON_SQUARE_MELOFEE
...
; New to Crystal
	...
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_AMONITA_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTIC_WATER_FROM_AMONITA_ITEM_ROOM
	const EVENT_PICKED_UP_STARDUST_FROM_AMONITA_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_AMONITA_ITEM_ROOM
	const EVENT_PICKED_UP_GOLD_BERRY_FROM_PTERA_ITEM_ROOM
	const EVENT_PICKED_UP_MOON_STONE_FROM_PTERA_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_PTERA_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGY_ROOT_FROM_PTERA_ITEM_ROOM
